...
namespace Final_Project___CGC_Sage
{
    public partial class frmGameOver : Form
    {
        ...
        private void frmGameOver_Load(object sender, EventArgs e)
        {
            ...
            // Play initial sound
            System.Media.SoundPlayer sfx = new System.Media.SoundPlayer(Properties.Resources.heartBreak);
            sfx.Play();
        }
        ...
        private void HeartTimer_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    bgmDelay.Stop();
                    System.Media.SoundPlayer sfx = new System.Media.SoundPlayer(Properties.Resources.gameOverBGM);
                    sfx.PlayLooping();
                };
                bgmDelay.Start();
