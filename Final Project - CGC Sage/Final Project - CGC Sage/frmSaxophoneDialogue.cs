...
{
    public partial class frmSaxophoneDialogue : Form
    {
            ...
            dialogueLines = new List<string>
                {
                    ...
                    "\"Uy! Saxophone!\"",
                    "It reminded you about someone...",
                    "Saxophone of King Alfonze V. Mangundayao",
                };
        ...
        private void frmSaxophoneDialogue_Load(object sender, EventArgs e)
        {
        ...
        private void PlaySound()
        {
            try
            {
                ...
                SoundPlayer player = new SoundPlayer("C:\\Users\\gello\\source\\repos\\Final Project - CGC Sage\\Final Project - CGC Sage\\saxsound.wav");  // Replace with your file's path
        ...
        private void typingTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                lblKing.Text += dialogueLines[currentLineIndex][currentCharIndex];
                currentCharIndex++;
                anyTextLeft = true;
            }
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (keyData == Keys.Z)
            {
                ...
                else
                {
                    ...
                    if (currentLineIndex < dialogueLines.Count)
                    {
                        lblKing.Text = dialogueLines[currentLineIndex];
        ...
        private void CenterLabels()
        {
            ...
            lblKing.BackColor = Color.Transparent;
            ...
            lblKing.TextAlign = ContentAlignment.MiddleCenter;
            ...
            lblKing.Location = new Point(0, (this.ClientSize.Height / 3) - (lblKing.Height / 2));
